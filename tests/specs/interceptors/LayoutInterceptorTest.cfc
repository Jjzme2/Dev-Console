 ...
 */
component extends="coldbox.system.testing.BaseInterceptorTest" interceptor="interceptors.LayoutInterceptor" {
	...
	function run ()
	{
		Describe( "interceptors.LayoutInterceptor", function ()
		{
